...
func (bu *BookUpdate) SetHeight(s string) *BookUpdate {
	bu.mutation.SetHeight(s)
	return bu
}
...
// SetHeight sets the "height" field.
func (buo *BookUpdateOne) SetHeight(s string) *BookUpdateOne {
	buo.mutation.SetHeight(s)
	return buo
}
