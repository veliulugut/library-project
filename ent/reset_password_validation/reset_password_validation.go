...
const (
	// Label holds the string label denoting the reset_password_validation type in the database.
	...
	FieldCode = "code"
	// Table holds the table name of the reset_password_validation in the database.
	Table = "reset_password_validations"
)

// Columns holds all SQL columns for reset_password_validation fields.
var Columns = []string{
	FieldID,
	FieldEmail,
	FieldExpireDate,
...
// OrderOption defines the ordering options for the Reset_Password_Validation queries.
